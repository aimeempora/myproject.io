...
<form action="Dashb.php" method="POST" style="max-width:500px;margin:auto;">
  <h3>Fill in Form</h3>
  ...
  <div class="input-container">
    ...
    <input class="input-field" type="password" placeholder="Password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[@#!$%^&*]).{10,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 10 or more characters" required="">
  </div>
 <div class="input-container">
    <i class="fa fa-key icon"></i>
  ...
  <div class="mt-4">
         <div class="d-flex justify-content-center links">
            I already have an account !&nbsp; <a href="log.php" class="ml-2" style="color: blue;text-decoration: none;">Login here</a>
      </div> </div><br>
</form></div>
